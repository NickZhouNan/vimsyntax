...
syn keyword sqlKeyword  successful synonym table then to trigger
...
syn keyword sqlKeyword  format delimited lines fields terminated by collection items external
...
syn keyword sqlKeyword  coalesce case when rcfile left
...
syn keyword sqlOperator histogram_numeric collect_set inline explode concat_ws
